...
"""
 PYTHONPATH:
        ...
        for tinystories 3M:
        PYTHONPATH=. python -m pocket_narrator.models.mamba.train_tokenizer_and_lm_dataset \
        --config configs/mamba_tinystories_3M/train_tokenizer_and_lm_dataset.yaml
